...
<div class="container mt-4">
    ...
    <form action="" method="post">
        <div class="form-group">
            ...
            <input type="password" class="form-control" name ="usr" id="pwd" placeholder="Enter username">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" name ="confirm_password" id="con_pwd" placeholder="Confirm Password">
        </div>
        <div class="form-row">
        </div>
        <div class="form-group">
